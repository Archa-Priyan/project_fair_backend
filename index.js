...
//import mongoose or connection.js file
...
//second srg -to export the upload folder
pfServer.use('/uploads',express.static('./uploads'))



//7)custome port - as by default server  run  at 3000
...
pfServer.get('/',(req,res)=>{
    res.send(`<h5>project fair server running successfully and waiting for client request</h5>`)
